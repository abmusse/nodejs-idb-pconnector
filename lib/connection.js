...
class Connection {
  ...
  /**
   * Returns the qualified job name of the Connection.
   * @returns {Promise} - Promise object resolves to qualified job name of the Connection.
   * @memberof Connection
   */
  async getJobName() {
    const conn = this.dbconn;
